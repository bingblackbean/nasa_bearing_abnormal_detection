...
use_cols = ['Datetime','Bearing 1-A','Bearing 1-B','Bearing 2-A','Bearing 2-B','Bearing 3-A','Bearing 3-B','Bearing 4-A','Bearing 4-B'] # rename columns
merged_data.columns = use_cols
...
merged_data = pd.read_csv('1st_test_resmaple_10minutes.csv',index_col='Datetime',usecols=use_cols)
