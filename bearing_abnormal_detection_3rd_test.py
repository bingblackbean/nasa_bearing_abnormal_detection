...
"""
# folder = r'C:\Users\renb\Downloads\nasa\3rd_test'
# data_dir = folder+'\\4th_test\\txt'
...
# merged_data.to_csv('3rd_test_resmaple_10minutes.csv')

"""
read from new dataset if you don't want to download the original dataset
"""

merged_data = pd.read_csv('3rd_test_resmaple_10minutes.csv',index_col='Datetime',usecols=['Datetime','Bearing 1','Bearing 2','Bearing 3','Bearing 4'])
...
dataset_train = merged_data['2004-03-04 09:27:46':'2004-04-01 00:01:57']
dataset_test = merged_data['2004-04-01 00:01:57':]
...
print(anomaly_alldata[anomaly_alldata['Anomaly']==1].index)